  ...
  return (
    ...
    >
      <div className="h-10 bg-gray-50 border-b border-gray-200 flex items-center gap-2 px-4">
        ...
        <div className="ml-3 text-xs text-gray-500 font-mono truncate">vantage.app / dashboard</div>
      </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="mt-12 w-full max-w-4xl">
                <div className="w-full rounded-xl border border-gray-200 shadow-lg overflow-hidden">
                  <img 
                    src="https://customer-assets.emergentagent.com/job_omniguard/artifacts/tclhsz1u_image.png" 

  ...
  const applications = [
    {
      ...
      productId: products[0].id, // Product Liability Insurance
      productPrice: 25000, // Customer's product price
      coverageAmount: 3000000,
      status: 'approved',
      riskScore: 42,
      recommendedPremium: 1250, // 5% of product price (good risk)
      actualPremium: 1300, // Set by underwriter
    ...
    },
    {
      ...
      productId: products[3].id, // Refund Protection
      productPrice: 15000,
      coverageAmount: 1500000,
      status: 'approved',
      riskScore: 35,
      recommendedPremium: 750, // 5% of product price
      actualPremium: 800,
      assignedUnderwriter: 'Underwriting Team',
    ...
    },
    {
      ...
      founderEmail: 'rahul@techventure.com',
      requestedCoverage: 'Product Liability',
      productId: products[0].id,
      productPrice: 18000,
      coverageAmount: 2000000,
      status: 'under_review',
      riskScore: 48,
      recommendedPremium: 1440, // 8% of product price (medium risk)
      actualPremium: null, // Not set yet
      assignedUnderwriter: 'Underwriting Team',
    ...
    },
    {
      ...
      founderEmail: 'meera@smartretail.com',
      requestedCoverage: 'Refund Protection',
      ...
      status: 'new',
      riskScore: null,
      recommendedPremium: null, // Not calculated yet
      actualPremium: null,
